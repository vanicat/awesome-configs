...
#+begin_src lua :tangle myconf.lua
  ...
  key_spawn({}, "XF86AudioMedia",       "xbmc"),
  key_spawn({}, "XF86Music",            "miro"),
  key_spawn({}, "XF86Tools",            "gnome-volume-control.pulse"),
  key_spawn({}, "XF86Sleep",            "sudo pm-hibernate"),
  key_spawn({}, "XF86HomePage",		webbrowser),
  key_spawn({}, "XF86Mail",		emacs),
#+end_src lua
