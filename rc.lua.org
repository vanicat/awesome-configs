...
#+begin_src lua :tangle myconf.lua
  ...
  awful.rules.rules = {
      ...
      { rule = { class = "Calibre", instance = "calibre" },
        properties = { tag = ((hostname == "corbeau") and tag_by_name["te"][snd_screen]) or tag_by_name["pl"][1] } },
      { rule = { class = "Iceweasel", instance = "Navigator" },
        properties = { tag = tag_by_name["net"][snd_screen] } },
      ...
      { rule = { class = "gimp" },
        properties = { floating = true } },
      { rule = { class = "Emacs" },
        properties = { tag = tag_by_name["em"][snd_screen] } },
      { rule = { class = "Miro.real"},
        properties = { tag = tag_by_name["pl"][snd_screen] } },
      { rule = { instance = "gajim.py" },
        properties = { tag = tag_by_name["IM"][snd_screen] } },
      { rule = { class = "Transmission" },
        properties = { tag = tag_by_name["sup2"][snd_screen] } },
      { rule = { instance = "xmms-gtk-rater" },
        properties = { tag = tag_by_name["pl"][fst_screen] } },
...
#+BEGIN_SRC lua :tangle myconf.lua
  function select_browser(tag)
     ...
     if(tag_by_name["net"][snd_screen].selected) then
        ntag = tag_by_name["net"][snd_screen]
     elseif (tag_by_name["net"][fst_screen].selected) then
...
* the xsessionrc
  #+begin_src sh :tangle ~/.xsessionrc
    ...
    if [ $(hostname) = "corbeau" ]; then
        ...
        xrandr --output DFP9 --left-of DFP10
    fi
